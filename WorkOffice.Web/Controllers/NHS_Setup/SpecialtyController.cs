...
namespace WorkOffice.Web.Controllers
{
   ...
   // [Authorize]
    public class SpecialtyController : ControllerBase
    {
        ...
        public SpecialtyController(ISpecialtyService _service, IHttpAccessorService _httpAccessorService)
        {
            service = _service;
        ...
        public async Task<IActionResult> CreateSpecialty(SpecialtyViewModels model)
        {
            try
            {
                var apiResponse = await service.CreateSpecialty(model);
        ...
        [ProducesResponseType(201, Type = typeof(CreateResponse))]
        [ProducesResponseType(400, Type = typeof(CreateResponse))]
        public async Task<IActionResult> UpdateSpecialty(SpecialtyViewModels model)
        {
            try
            {
                var apiResponse = await service.UpdateSpecialty(model);
                if (apiResponse.StatusCode == System.Net.HttpStatusCode.BadRequest)
                {
                    return BadRequest(apiResponse.ResponseType);
                }
        ...
        [HttpPost]
        [Route("GetList")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(GetResponse<List<SpecialtyViewModels>>))]
        ...
        [HttpGet]
        [Route("Get")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(GetResponse<SpecialtyViewModels>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(GetResponse<ProducesResponseStub>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(GetResponse<ProducesResponseStub>))]
        public async Task<IActionResult> Get(long specialtyId)
        {
            try
            {
                var apiResponse = await service.Get(specialtyId);
                if (apiResponse.StatusCode == System.Net.HttpStatusCode.BadRequest)
                {
                    return BadRequest(apiResponse.ResponseType);
                }
        ...
        public async Task<IActionResult> Delete(long specialtyId)
        {
            try
            {
                var apiResponse = await service.Delete(specialtyId);
                if (apiResponse.StatusCode == System.Net.HttpStatusCode.BadRequest)
                {
                    return BadRequest(apiResponse.ResponseType);
                }
