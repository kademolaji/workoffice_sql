...
namespace WorkOffice.Web.DataSeeder
{
    ...
    public class UserActivitiesSeeder
    {
        ...
        public void SeedData()
        {
            ...
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Diagnostic_Information, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Diagnostic_Information).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Referral_Information, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Referral_Information).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.DiagnosticResult_Document, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.DiagnosticResult_Document).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            ...
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Outpatient_Waitinglist, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Outpatient_Waitinglist).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Inpatient_Waitinglist, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Inpatient_Waitinglist).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Booked_Appointment, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Booked_Appointment).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
            AddNewData(new UserActivity { UserActivityId = (long)UserActivitiesEnum.Partial_Appointment, UserActivityName = Enum.GetName(typeof(UserActivitiesEnum), UserActivitiesEnum.Partial_Appointment).Replace("_", " "), UserActivityParentId = (long)UserActivityParentEnum.NHS, ClientId = 1 });
