...
import { DeleteConsultantDialogComponent } from './dialog/delete/delete.component';

@Component({
  selector: 'app-all-consultant',
  templateUrl: './all-consultant.component.html',
  styleUrls: ['./all-consultant.component.css'],
})
export class AllConsultantComponent
  ...
  implements OnInit
{
  ...
  addNew() {
    this.router.navigate(['setup', 'consultant', 'add-consultant']);
  }

  editCall(row: { consultantId: number }) {
  ...
  deleteItem(row: ConsultantModel) {
