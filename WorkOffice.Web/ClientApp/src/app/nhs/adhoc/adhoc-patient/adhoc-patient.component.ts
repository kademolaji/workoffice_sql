...
@Component({
  selector: 'app-adhoc-patient',
  templateUrl: './adhoc-patient.component.html',
  styleUrls: ['./adhoc-patient.component.css']
})
export class AdhocPatientComponent
...
cancelForm(){
this.router.navigate(['nhs', 'adhoc', this.patientId]);
}
