...
@Component({
  selector: 'app-inpatient-waitinglist',
  templateUrl: './inpatient-waitinglist.component.html',
  styleUrls: ['./inpatient-waitinglist.component.css']
})
export class InpatientWaitinglistComponent
